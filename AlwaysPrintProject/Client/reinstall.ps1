...
try {
    ...
    # Nota: git escribe información de progreso a stderr (ej. "From https://..."),
    # lo cual dispara excepciones con $ErrorActionPreference="Stop". Se suspende temporalmente.
    ...
    if ($gitExitCode -ne 0) {
        ...
        throw "Git pull fallo con codigo $gitExitCode"
    }
